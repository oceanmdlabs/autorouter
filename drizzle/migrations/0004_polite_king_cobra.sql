...
CREATE TYPE "public"."llm_reason_code" AS ENUM('ROUTING_RULE_MATCHED', 'NO_ACTION_NEEDED', 'MISSING_INFORMATION', 'OUTSIDE_SCOPE', 'PATIENT_OPT_OUT', 'VALIDATION_FAILED', 'MODEL_ERROR');--> statement-breakpoint
...
ALTER TYPE "public"."ai_provider" ADD VALUE 'bedrock';--> statement-breakpoint
...
CREATE INDEX "idx_llm_rule_decision_audit_tenant_id" ON "llm_rule_decision_audit" USING btree ("tenant_id");--> statement-breakpoint
...
CREATE INDEX "idx_llm_rule_tool_execution_audit_tenant_id" ON "llm_rule_tool_execution_audit" USING btree ("tenant_id");--> statement-breakpoint
