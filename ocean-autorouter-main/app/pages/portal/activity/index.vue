    ...
    <div class="space-y-6">
      <div>
        ...
        <p class="mt-2 text-sm text-gray-600 leading-relaxed max-w-3xl">
          This area will show any actions performed by the system related to routing requests.
        </p>
      </div>
      ...
      <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8">
          <NuxtLink to="/portal/activity" class="border-primary text-primary whitespace-nowrap border-b-2 py-2 px-1 text-sm font-medium">
            Activity Log
          </NuxtLink>
          <NuxtLink to="/portal/activity/audit" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 whitespace-nowrap border-b-2 py-2 px-1 text-sm font-medium">
            LLM Audit Explorer
          </NuxtLink>
        </nav>
      </div>
